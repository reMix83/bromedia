...
const ICONS = {
  ...
  max: '<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd"><path d="M12 3.6c-4.8 0-8.4 3.4-8.4 8 0 4.2 2.9 7.3 6.9 7.8.1-1.1.2-2.3.2-3 .1-.9.2-1.7.3-2.3-2-.6-3.6-2.4-3.6-4.7 0-2.6 2.1-4.6 4.6-4.6s4.6 2 4.6 4.6-2 4.6-4.6 4.6c-.4 0-.8 0-1.2-.1-.1.5-.2 1.1-.4 1.7-.4 1.4-1 2.8-1.7 3.9 2.4.1 4.7-.6 6.4-2.1 1.8-1.6 2.9-3.9 2.9-6.6 0-4.6-3.6-8-8.6-8z"/></svg>',
