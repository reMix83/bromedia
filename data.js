...
const SITE = {
  ...
  /* ---------- Цифры на главной ---------- */
  stats: [
    { num: "5+",    lbl: "лет на рынке" },
    { num: "300+",  lbl: "проектов сдано" },
    { num: "12",    lbl: "регионов съёмок" },
    { num: "50+",   lbl: "компаний-клиентов" },
  ],

  /* ---------- О студии ---------- */
  about: {
    title: "Студия, где картинка работает на результат",
    text: "BRO MEDIA — продакшн-студия полного цикла. Мы берём проект от идеи и сценария до финального рендера: снимаем, монтируем, собираем графику и подключаем нейросети там, где это ускоряет и усиливает результат. Работаем с брендами, медиа, бизнесом и авторами — в Москве и по России.",
  },
